...
const _resizerSpace = 3; // HACK: magic number: 3, means resizer's size
const _tabbarSpace = 22; // HACK: magic number: 22, means tabbar's size
const _panelSpace = 4;   // HACK: magic number: 4, means panel's size
...
utils.saveLayout = function () {
  ...
  window.requestAnimationFrame ( () => {
    ipcPlus.sendToMain('dockable:save-layout', utils.dumpLayout());
  });
};
