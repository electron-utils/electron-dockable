...
class DockableWindow extends EventEmitter {
  constructor ( name, options ) {
    ...
    if ( options.x === undefined && options.y === undefined && DockableWindow.main ) {
      let display = electron.screen.getDisplayMatching( DockableWindow.main._browserWin.getBounds() );
  ...
  resetLayout ( info ) {
    ...
    this.send('electron-dockable:reset-layout', info);
  }
